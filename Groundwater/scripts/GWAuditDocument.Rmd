...
GWdata=get("GWdata",pos=1)#parent.frame()$wqdata#loadLatestDataRiver()
...
gwAudit = read.csv(tail(dir(path="H:/ericg/16666LAWA/LAWA2020/Groundwater/Audit",
...
ss <- read.csv(tail(dir(path = "h:/ericg/16666LAWA/LAWA2020/Groundwater/Analysis",
                        pattern = 'ITEGWState',
						full.names = T,recursive=T,ignore.case=T),1),stringsAsFactors = F)
ss=ss[which(tolower(ss$LawaSiteID)%in%agencyLIDs),]

GWtrend=read_csv(tail(dir(path = "h:/ericg/16666LAWA/LAWA2020/Groundwater/Analysis",
                          pattern="*GWTrend*.*",
...
```{r echo=F,results='asis'}
cat('  \n### Chloride\n')
knitr::include_graphics(tail(dir(path="H:/ericg/16666LAWA/LAWA2020/Groundwater/Audit",
...
```{r echo=F,results='asis'}
cat(tail(dir(path = "h:/ericg/16666LAWA/LAWA2020/Groundwater/Analysis",
                          pattern="ITEGWTrend*.*",
