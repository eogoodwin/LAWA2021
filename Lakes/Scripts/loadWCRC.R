...
# x <- readLines(paste0("H:/ericg/16666LAWA/LAWA2021/Lakes/Data/",format(Sys.Date(),"%Y-%m-%d"),"/wcrcLWQ.xml"))
# y <- gsub( "NumItems=\"1\"", "NumItems=\"2\"", x, ignore.case = TRUE  )
# y <- gsub( "SimpleTimeSeries", "WQData", y, ignore.case = TRUE  )
# 
# writeLines(y,con = paste0("H:/ericg/16666LAWA/LAWA2021/Lakes/Data/",format(Sys.Date(),"%Y-%m-%d"),"/wcrcLWQ.xml"))
